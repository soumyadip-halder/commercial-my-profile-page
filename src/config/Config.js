const envDetails = {
  dev: {
    ...
    GET_TASKLIST_ID: "commercial-user/v1/tasklist/{requestId}",
    PUT_TASKLIST_ID: "commercial-user/v1/tasklist/{requestId}",
    GET_TASKLIST_ALL: "commercial-user/v1/tasklist",
    GET_TASKLOG_ID: "commercial-user/v1/tasklog/{requestId}",
    GET_TASKLOG_ALL: "commercial-user/v1/tasklog",
    POST_TASKLOG_ID: "commercial-user/v1/tasklog",
